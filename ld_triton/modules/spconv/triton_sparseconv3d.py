...
from ld_triton.ops.spconv.triton_sparseconv3d import triton_sparseconv3d


# only support channel_last
class TritonSparseConv3d(torch.nn.Module):
    def __init__(self,                  
                 in_channels,
                 out_channels,
                 kernel_size,
        ...
        super(TritonSparseConv3d, self).__init__()
    ...
    def forward(self, x: SparseConvTensor):
        ...
        triton_out_features, triton_out_indices, PQ_0, PQ_1, PQ_2= triton_sparseconv3d(features, indices, 
        ...
        output = SparseConvTensor(triton_out_features, triton_out_indices, [PQ_0, PQ_1, PQ_2], batch_size)
        return output
