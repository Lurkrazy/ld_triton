...
from ld_triton.ops.spconv.naive_sparseconv3d import naive_sparseconv3d
...
class NaiveSparseConv3d(torch.nn.Module):
    ...
    def forward(self, x: SparseConvTensor):
        ...
        naive_out_features, naive_out_indices, PQ_0, PQ_1, PQ_2= naive_sparseconv3d(features, indices, 
